...
import { check_create_user_in_vm, check_resource_group_existance, create_docx_document, db_delete_exam_v2, db_is_prefix_unique_v2, db_list_active_exams_v2, db_list_exams_v2, db_update_exam_v2, delete_all_resource_groups, grant_access_to_doc, send_email, testFunction, create_storage_container, create_storage_container_sas } from '../utils/api.js';
...
const Content = () => <div>
  ...
  <Button onClick={() => create_storage_container("test")}>Create test container</Button>
  <Button onClick={() => create_storage_container_sas("test")}>Create SAS test container</Button>
