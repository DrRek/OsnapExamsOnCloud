...
export default function AllExamsTable({ exams, selectedExams, onSelectionChange, refreshing, onRefresh, onDeleteExamsFromDB, onShowDetails, deletingExamsFromDB, downloadDesktop }) {
